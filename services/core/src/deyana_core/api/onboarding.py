...
@router.patch("/onboarding/state", response_model=OnboardingCompleteResponse)
async def update_onboarding_state(
    request: Request, payload: OnboardingProgressRequest
) -> OnboardingCompleteResponse:
    runtime = request.app.state.runtime
    try:
        state, settings = runtime.store.update_onboarding_progress(
